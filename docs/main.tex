...
\begin{equation}
  V = \frac{1}{2} I \dot{\theta}^2 + Mg (- \cos\theta) + \frac{1}{2} k_1 \dot{\varphi}^2, \quad k_1 > 0
\end{equation}
...
\begin{align}
  \dot{V} &= I \dot{\theta} \ddot{\theta} + Mg \dot{\theta} \sin\theta + k_1 \dot{\varphi} \ddot{\varphi} \nonumber \\
          &= \dot{\theta}(2Mg \sin\theta - \tau_m) + k_1 \dot{\varphi}\left(\frac{(I + I_w)}{I I_w}\tau_m - \frac{Mg \sin\theta}{I}\right)
  \label{eqn_vdot}
\end{align}
...
\begin{equation}
  \tau_m = 2Mg \sin\theta + k_2 \dot{\theta} - \tau_{f}- k_1 \frac{(I + I_w)}{I I_w} \dot{\varphi}
  \label{eqn_ctrl}
\end{equation}
...
\begin{enumerate}
  ...
  \begin{align}
    0 &= Mg\sin\theta - \tau_m \label{eq:theta_eq} \\
    0 &= \frac{(I + I_w)\tau_m}{I I_w} - \frac{Mg\sin\theta}{I} \label{eq:phi_eq}
  \end{align}
  ...
  \begin{equation}
      Mg\sin\theta = 2Mg\sin\theta \implies \sin\theta = 0
  \end{equation}
\end{enumerate}
...
\begin{equation*}
  \tau_m=2Mg\sin\theta+k_{2}\dot{\theta}-\tau_{f}-k_1\frac{(I+I_w)}{II_w}\dot{\varphi}
\end{equation*}
